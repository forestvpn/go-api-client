...
func (o *DeviceListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeviceListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewDeviceListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *DeviceListOK) Error() string {
	return fmt.Sprintf("[GET /devices/][%d] deviceListOK  %+v", 200, o.Payload)
}
func (o *DeviceListOK) GetPayload() models.DeviceList {
	return o.Payload
}

func (o *DeviceListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeviceListDefault) Error() string {
	return fmt.Sprintf("[GET /devices/][%d] DeviceList default  %+v", o._statusCode, o.Payload)
}
func (o *DeviceListDefault) GetPayload() *models.Error {
	return o.Payload
}

func (o *DeviceListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
