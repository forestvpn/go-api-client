...
type ClientService interface {
	InterfaceList(params *InterfaceListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*InterfaceListOK, error)
...
func (a *Client) InterfaceList(params *InterfaceListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*InterfaceListOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Params:             params,
		Reader:             &InterfaceListReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*InterfaceListOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*InterfaceListDefault)
